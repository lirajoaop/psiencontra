  ...
  return (
    <main className="flex-1">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <h2 className="text-2xl md:text-3xl font-bold text-violet-900 text-center mb-12">
          Como funciona?
        </h2>
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            >
              <div className="w-14 h-14 rounded-full bg-violet-100 text-violet-700 flex items-center justify-center text-xl font-bold mx-auto mb-4">
                {item.step}
              </div>
              <h3 className="font-bold text-violet-900 text-lg mb-2">{item.title}</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {approaches.map((a, i) => (
              <motion.div
                ...
                className="p-4 rounded-xl border border-violet-100 hover:shadow-md transition-shadow"
              >
                <div
                  className="w-3 h-3 rounded-full mb-3"
                  style={{ backgroundColor: a.color }}
                />
                <h4 className="font-bold text-violet-900 text-sm mb-1">{a.label}</h4>
      ...
      {/* Footer */}
      <footer className="bg-violet-900 text-violet-200 py-6 text-center text-sm">
