...
export default function RegisterPage() {
  ...
  return (
    <main className="flex-1 flex items-center justify-center px-6 py-16 bg-gradient-to-br from-violet-50 to-purple-50 dark:from-gray-900 dark:to-gray-950">
      ...
      >
        <h1 className="text-2xl font-bold text-violet-900 dark:text-violet-200 mb-2 text-center">Criar conta</h1>
        <p className="text-sm text-gray-600 dark:text-gray-400 text-center mb-8">
          Salve seus resultados e acompanhe sua jornada
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-violet-500"
            />
          </div>
          <div>
